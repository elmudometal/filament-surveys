...
{
    public static string $name = 'filament-surveys';

    public static string $viewNamespace = 'filament-surveys';
    ...
    public function packageBooted(): void
    {
        ...
        if (app()->runningInConsole()) {
            foreach (app(Filesystem::class)->files(__DIR__ . '/../stubs/') as $file) {
                $this->publishes([
                    $file->getRealPath() => base_path("stubs/filament-surveys/{$file->getFilename()}"),
                ], 'filament-surveys-stubs');
            }
        }

        // Testing
        Testable::mixin(new TestsFilamentSurveys);
    }
